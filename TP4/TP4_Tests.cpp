...
void TP4_Tests::testComposite(){
	...
	// Nouveau test
	std::cout << std::endl << "=========================" << std::endl << std::endl;
	std::cout << "nouveau test pour le remove_triangle" << std::endl;
	std::cout << "effacer le premier element de la partie 4" << std::endl;
	part4.removeTriangle(part4.triangle_cbegin());
	outToStream(part4, "partie4", std::cout);
}
