...
void Objet3DTransform::addChild(const AbsObjet3D & obj)
{
	...
	// A COMPLETER
	return m_objet_cible->addChild(obj);
}
...
TriangleIterator Objet3DTransform::triangle_begin()
{
	...
	// A COMPLETER
	auto  iter = m_objet_cible->triangle_begin();
	iter.setTransform(this);
	return iter;
}
...
TriangleIterator Objet3DTransform::triangle_end()
{
	...
	// Retourne le resultat
	// A COMPLETER
	auto  iter = m_objet_cible->triangle_end();
	iter.setTransform(this);
	return iter;
}
...
TriangleIterator_const Objet3DTransform::triangle_cbegin() const
{
	...
	// Retourne le resultat
	// A COMPLETER
	auto  iter = m_objet_cible->triangle_cbegin();
	iter.setTransform(this);
	return iter;
}
...
TriangleIterator_const Objet3DTransform::triangle_cend() const
{
	...
	// Retourne le resultat
	// A COMPLETER
	auto  iter = m_objet_cible->triangle_cend();
	iter.setTransform(this);
	return iter;
}
